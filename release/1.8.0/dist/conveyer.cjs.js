...
function isIntersection(pos1, pos2, target, intersection) {
  ...
  var intersectionRatio = intersection === true ? 1 : intersection;
  var size = intersectionRatio * Math.abs(pos2 - pos1);
...
function (_super) {
  ...
  function Conveyer(scrollArea, options) {
    ...
    _this._panInput = null;
    _this._wheelInput = null;
    /**
  ...
  __proto.updateItems = function () {
    ...
    var prevItemElements = this._items.map(function (item) {
      return item.element;
    });
    ...
    if (resizeObserver) {
      var changed_1 = childrenDiffer.diff(prevItemElements, itemElements);
      var removed = changed_1.removed;
      var added = changed_1.added;
      removed.forEach(function (index) {
        return resizeObserver.unobserve(changed_1.prevList[index]);
      });
      added.forEach(function (index) {
        return resizeObserver.observe(changed_1.list[index]);
      });
    }
  };
  /**
  ...
  __proto.enableInput = function () {
    ...
    (_b = this._wheelInput) === null || _b === void 0 ? void 0 : _b.enable();
  };
  /**
  ...
  __proto.disableInput = function () {
    ...
    (_b = this._wheelInput) === null || _b === void 0 ? void 0 : _b.disable();
  };
  /**
  ...
  __proto.init = function () {
    ...
    if (options.useDrag) {
      this._panInput = new Axes.PanInput(scrollAreaElement, {
    ...
    if (options.useSideWheel) {
      this._wheelInput = new Axes.WheelInput(scrollAreaElement, {
        useNormalized: false
      });
    ...
    if (options.useResizeObserver && window.ResizeObserver) {
      this._resizeObserver = new ResizeObserver(function (entries) {
        ...
        entries.forEach(function (entry) {
          if (entry.target !== _this._scrollAreaElement) {
        ...
        for (var i = index; i < length; i++) {
          items[i] = _this._getItem(items[i].element);
        }
    ...
    this.update();
    (_a = this._resizeObserver) === null || _a === void 0 ? void 0 : _a.observe(scrollAreaElement);
  ...
  __proto._createAnimationParam = function (pos) {
 ...
 * MIT license
 */
var CONVEYER_METHODS = ["update", "findElement", "findItem", "scrollBy", "scrollTo", "scrollIntoView", "setItems", "updateContainer", "updateItems", "init", "enableInput", "disableInput"];

...
(function (global, factory) {
    ...
    */
    ...
    var CFCS_DETECTED_DEPENDENCIES_VERSION$1 = 1;
    var CFCS_DETECTED_DEPENDENCIES$1 = "__CFCS_DETECTED_DEPENDENCIES__";

    function getDetectedStack$1() {
      // Version issues do not occur when you access the native object in the global.
      Object[CFCS_DETECTED_DEPENDENCIES$1] = Object[CFCS_DETECTED_DEPENDENCIES$1] || {};
      var versionList = Object[CFCS_DETECTED_DEPENDENCIES$1];
      versionList[CFCS_DETECTED_DEPENDENCIES_VERSION$1] = versionList[CFCS_DETECTED_DEPENDENCIES_VERSION$1] || [];
      return versionList[CFCS_DETECTED_DEPENDENCIES_VERSION$1];
    }
    function getCurrentDetected$1() {
      var stack = getDetectedStack$1();
      return stack[stack.length - 1];
    }
    ...
    function () {
      ...
      Object.defineProperty(__proto, "current", {
        get: function () {
          var currentDetected = getCurrentDetected$1();
          currentDetected === null || currentDetected === void 0 ? void 0 : currentDetected.push(this);
          return this._current;
        },
        set: function (value) {
    ...
    function injectObserve$1(prototype, memberName, publicName) {
      if (publicName === void 0) {
        publicName = memberName;
      }
    ...
    function Observe$1() {
      ...
      if (args.length > 1) {
        return injectObserve$1(args[0], args[1]);
      }

      return function (prototype, memberName) {
        return injectObserve$1(prototype, memberName, args[0]);
      };
    }
    function Reactive() {
      var args = [];
      ...
      return Observe$1.apply(void 0, args);
    }
    ...
    function defineObservers$1(instance) {
      var observers = {};
